...
public class IdentityApiDelegationAccessTokenRetriever(
    ILogger<IdentityApiDelegationAccessTokenRetriever> logger,
...
{
    public override RemoteApi RemoteApi => RemoteApi.Identity;
}
