...
public class RequestApiDelegationAccessTokenRetriever(
    ILogger<RequestApiDelegationAccessTokenRetriever> logger,
...
{
    public override RemoteApi RemoteApi => RemoteApi.Request;
}
