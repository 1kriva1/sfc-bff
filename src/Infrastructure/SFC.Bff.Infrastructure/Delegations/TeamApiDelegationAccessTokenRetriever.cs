...
public class TeamApiDelegationAccessTokenRetriever(
    ILogger<TeamApiDelegationAccessTokenRetriever> logger,
...
{
    public override RemoteApi RemoteApi => RemoteApi.Team;
}
