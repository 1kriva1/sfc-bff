...
public class InviteApiDelegationAccessTokenRetriever(
    ILogger<InviteApiDelegationAccessTokenRetriever> logger,
...
{
    public override RemoteApi RemoteApi => RemoteApi.Invite;
}
