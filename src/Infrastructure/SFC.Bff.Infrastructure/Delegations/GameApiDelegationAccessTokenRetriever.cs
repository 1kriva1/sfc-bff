...
public class GameApiDelegationAccessTokenRetriever(
    ILogger<GameApiDelegationAccessTokenRetriever> logger,
...
{
    public override RemoteApi RemoteApi => RemoteApi.Game;
}