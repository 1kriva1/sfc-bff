...
import { GamePreviewLocalization } from './game-preview.localization';
...
import { GamePreviewConstants } from './game-preview.constants';
import { ITeamInfoModel } from '@share/components';
import { ITeamModel } from '@share/models';
import { IGamePreviewViewModel } from './models/game-preview-view.model';
...
export class GamePreviewComponent
    ...
    Localization = GamePreviewLocalization;
    ...
    public teams$: Observable<IGamePreviewViewModel> = EMPTY;
    ...
    ngOnInit(): void {
        ...
        this.teams$ = this.gamePreviewService.value$.pipe(
            map((model: IGamePreviewModel) => {
                return {
