export class GeneralFilterLocalization {
    static get BUTTON_OK_LABEL(): string { return $localize`:@@core.action.ok:Ok`; }
    static get BUTTON_CANCEL_LABEL(): string { return $localize`:@@core.action.cancel:Cancel`; }
    static get BUTTON_CLEAR_LABEL(): string { return $localize`:@@core.action.clear:Clear`; }
