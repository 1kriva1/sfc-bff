...
import { PlayersTableLocalization } from "../../localization/players-table.localization";
    ...
    describe('Columns', () => {
        ...
        describe('Photo', () => {
            fit('Should player info panel has defined attributes', () => {
                const playerInfoPanelEl = fixture.debugElement.query(By.css('.column.photo > sfc-player-info')),
                ...
                expect(playerInfoPanelComponent.model).toEqual({
                    raiting: 50,
                    photo: CoreConstants.DEFAULT_AVATAR_PATH
                });
            });
        });
        ...
        describe('Name', () => {
            fit('Should player info panel has defined attributes', () => {
                const playerInfoPanelEl = fixture.debugElement.query(By.css('.column.name > sfc-player-info')),
                    playerInfoPanelComponent = playerInfoPanelEl.componentInstance;
        ...
        describe('Actions', () => {
            ...
            fit('Should navigate to profile page for profile action', () => {
                ...
                expect(routerMock.navigate)
                    .toHaveBeenCalledWith([`${PlayerRoute.Players}/${component.model.id}`]);
            });
        });
    });
