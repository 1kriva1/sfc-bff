...
describe('Share.Component: PlayerInfo', () => {
    ...
    describe('General', () => {
        ...
        fit('Should have default radius', () => {
            expect(component.radius).toEqual(PlayerInfoConstants.DEFAULT_RADIUS);
        });

        fit('Should have default stroke', () => {
            expect(component.stroke).toEqual(PlayerInfoConstants.DEFAULT_STROKE);
        });
