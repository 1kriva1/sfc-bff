...
import { ISearchPlayersFilterModel } from '../../../components/players/search/filters';
import { IFindPlayersRequest, IPlayerItemModel } from "../../../services/player/models/find";
import { IPlayersTableModel, PlayersTableColumn, PlayersTableSorting } from "../../../components/players/search/table";
import { convertFromServerStats } from "../../../utils";

export function mapFindPlayersRequest(
    model: ISearchPlayersFilterModel,
    page: number,
    size: number,
